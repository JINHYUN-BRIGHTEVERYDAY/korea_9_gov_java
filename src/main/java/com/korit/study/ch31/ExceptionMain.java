...
* 오류 (사용자 제어 불가능) -> OutOfMemoryError(메모리 공간 부족), StackOverFlowError()
...
* 1. 실행 중 발생하는 예외
* 2. 처리를 선택적으로 해줄 수 있음
* 3. 주소 참조, 실행 도중 자원(스레드, 인스턴스)의 부재
...
//            }
//            try {
//                System.out.println(name.startsWith("김")); // try 영역에 예외 발생 가능성 코드 집어넣기
//            } catch (NullPointerException e) {
//                e.printStackTrace(); // 어떤 예외가 발생했는지 print
//                break;
//            }
//
//            count++;
